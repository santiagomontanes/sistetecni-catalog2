...
const MATRIX:Record<ErpRole,readonly ErpPermission[]>={
  ...
  caja:["sales.read","cash.read","cash.manage","expenses.read","expenses.manage"],
  bodega:["inventory.read","inventory.manage","inventory.reserve","purchases.read","purchases.manage"],
  viewer:[],
};
